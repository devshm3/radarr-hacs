 ...
 */async function ve(e,t,i={}){const r={type:"radarr_hacs/get_movies",entry_id:t};i.filter&&"all"!==i.filter&&(r.filter=i.filter),i.sort&&(r.sort=i.sort),i.search&&(r.search=i.search);return(await e.connection.sendMessagePromise(r)).movies}async function _e(e,t){return e.connection.sendMessagePromise({type:"radarr_hacs/get_config",entry_id:t})}let fe=class extends ne{constructor(){super(...arguments),this._entries=[],this._entriesLoaded=!1}setConfig(e){this._config={...e},this.requestUpdate()}updated(e){e.has("hass")&&this.hass&&!this._entriesLoaded&&(this._entriesLoaded=!0,this._loadEntries())}async _loadEntries(){var e;try{const t=await this.hass.connection.sendMessagePromise({type:"config_entries/get",domain:ge});this._entries=t.filter(e=>e.domain===ge),1!==this._entries.length||(null===(e=this._config)||void 0===e?void 0:e.entry_id)||this._fire({entry_id:this._entries[0].entry_id})}catch{this._entries=[]}}render(){var e,t,i,r;if(!this._config)return L``;const o=this._config;return L`
  ...
  `,e([pe({type:Boolean,reflect:!0})],$e.prototype,"open",void 0),e([pe({attribute:!1})],$e.prototype,"movie",void 0),e([pe({attribute:!1})],$e.prototype,"qualityProfiles",void 0),e([pe({attribute:!1})],$e.prototype,"rootFolders",void 0),e([pe({type:Boolean})],$e.prototype,"showQuality",void 0),e([pe({type:Boolean})],$e.prototype,"showFileInfo",void 0),e([ue()],$e.prototype,"_profileId",void 0),e([ue()],$e.prototype,"_folder",void 0),e([ue()],$e.prototype,"_monitored",void 0),e([ue()],$e.prototype,"_adding",void 0),e([ue()],$e.prototype,"_addError",void 0),e([ue()],$e.prototype,"_confirmDelete",void 0),e([ue()],$e.prototype,"_searchQueued",void 0),$e=e([de("radarr-movie-detail")],$e);const xe="radarr_hacs";let we=class extends ne{constructor(){super(...arguments),this._movies=[],this._filteredMovies=[],this._qualityProfiles=[],this._rootFolders=[],this._dialogOpen=!1,this._activeFilter="all",this._searchTerm="",this._tmdbForced=!1,this._isTmdbView=!1,this._loading=!1,this._initialised=!1,this._searchGen=0}static getConfigElement(){return document.createElement("radarr-hacs-card-editor")}static async getStubConfig(e){var t;try{const i=(await e.connection.sendMessagePromise({type:"config_entries/get",domain:xe})).find(e=>e.domain===xe);return{entry_id:null!==(t=null==i?void 0:i.entry_id)&&void 0!==t?t:""}}catch{return{entry_id:""}}}setConfig(e){var t;if(!e.entry_id)throw new Error("entry_id is required");this._config={columns:4,default_sort:"added",default_filter:"all",show_status_badges:!0,poster_radius:8,page_size:25,show_quality:!0,show_file_info:!0,show_filter_counts:!0,show_refresh_button:!0,...e},this._activeFilter=null!==(t=this._config.default_filter)&&void 0!==t?t:"all"}getCardSize(){var e,t;const i=null!==(t=null===(e=this._config)||void 0===e?void 0:e.columns)&&void 0!==t?t:4,r=this._displayMovies.length||this._pageSize||25;return 3+3*Math.max(1,Math.ceil(r/i))}getGridOptions(){return{columns:"full",rows:"auto"}}updated(e){var t,i,r,o,s,a;if(e.has("hass")||e.has("_config")){this.setAttribute("data-appearance",null!==(i=null===(t=this._config)||void 0===t?void 0:t.appearance)&&void 0!==i?i:"glass");const e=null!==(s=null===(o=null===(r=this.hass)||void 0===r?void 0:r.themes)||void 0===o?void 0:o.darkMode)&&void 0!==s?s:window.matchMedia("(prefers-color-scheme: dark)").matches;this.toggleAttribute("data-dark",!!e)}e.has("hass")&&this.hass&&this._config&&!this._initialised&&(this._initialised=!0,this._loadData()),e.has("_dialogOpen")&&this._dialogOpen&&(null===(a=this._dialog)||void 0===a||a.showModal())}get _pageSize(){var e,t;return null!==(t=null===(e=this._config)||void 0===e?void 0:e.page_size)&&void 0!==t?t:25}get _displayMovies(){return this._pageSize>0?this._filteredMovies.slice(0,this._pageSize):this._filteredMovies}get _hasMore(){return this._pageSize>0&&this._filteredMovies.length>this._pageSize}_matchesFilter(e,t){switch(t){case"available":return!!e.hasFile;case"missing":return!e.hasFile&&!!e.monitored;case"unmonitored":return!e.hasFile&&!e.monitored;case"downloading":return!!e.inQueue;default:return!0}}_applyActiveFilter(){this._filteredMovies="all"===this._activeFilter?this._movies:this._movies.filter(e=>this._matchesFilter(e,this._activeFilter))}get _filterCounts(){const e=this._movies;return{all:e.length,available:e.filter(e=>this._matchesFilter(e,"available")).length,missing:e.filter(e=>this._matchesFilter(e,"missing")).length,downloading:e.filter(e=>this._matchesFilter(e,"downloading")).length,unmonitored:e.filter(e=>this._matchesFilter(e,"unmonitored")).length}}disconnectedCallback(){super.disconnectedCallback(),this._queueTimer&&(clearInterval(this._queueTimer),this._queueTimer=void 0)}async _loadData(e=!1){var t,i,r,o;const s=e?null===(t=this._selectedMovie)||void 0===t?void 0:t.id:void 0,a=e?null===(i=this._dialogSelectedMovie)||void 0===i?void 0:i.id:void 0;this._loading=!e,this._error=void 0;try{const[e,t]=await Promise.all([ve(this.hass,this._config.entry_id,{sort:this._config.default_sort}),_e(this.hass,this._config.entry_id)]);this._movies=e,this._qualityProfiles=t.quality_profiles,this._rootFolders=t.root_folders,this._isTmdbView||(this._applyActiveFilter(),null!=s&&(this._selectedMovie=null!==(r=e.find(e=>e.id===s))&&void 0!==r?r:this._selectedMovie),null!=a&&(this._dialogSelectedMovie=null!==(o=e.find(e=>e.id===a))&&void 0!==o?o:this._dialogSelectedMovie));const i=e.some(e=>e.inQueue);i&&!this._queueTimer?this._queueTimer=setInterval(()=>this._loadData(!0),15e3):!i&&this._queueTimer&&(clearInterval(this._queueTimer),this._queueTimer=void 0)}catch(e){this._error=`Could not connect to Radarr: ${e}`}finally{this._loading=!1}}_onSearchInput(e){this._searchTerm=e.target.value,this._searchGen++,clearTimeout(this._debounceTimer),this._tmdbForced=!1,this._isTmdbView=!1;const t=this._searchTerm.toLowerCase();t?(this._filteredMovies=this._movies.filter(e=>e.title.toLowerCase().includes(t)||String(e.year).includes(t)),0===this._filteredMovies.length&&(this._debounceTimer=setTimeout(()=>this._tmdbSearch(),400))):this._applyActiveFilter()}_forceSearchTmdb(){this._tmdbForced=!0,this._searchGen++,clearTimeout(this._debounceTimer),this._tmdbSearch()}async _tmdbSearch(){if(!this._searchTerm)return;const e=this._searchGen;try{const t=await async function(e,t,i){return(await e.connection.sendMessagePromise({type:"radarr_hacs/search_movies",entry_id:t,term:i})).results.map(e=>{var t,i;const r=(null!==(t=e.id)&&void 0!==t?t:0)>0;return{...e,inLibrary:r,id:r?e.id:-(null!==(i=e.tmdbId)&&void 0!==i?i:0)}})}(this.hass,this._config.entry_id,this._searchTerm);this._searchGen===e&&(this._filteredMovies=t,this._isTmdbView=!0)}catch(e){}}_onFilterChange(e){this._activeFilter=e,this._selectedMovie=void 0,this._dialogSelectedMovie=void 0,this._isTmdbView=!1,this._tmdbForced=!1,this._searchTerm="",this._applyActiveFilter()}_onPosterClick(e){var t;this._selectedMovie=(null===(t=this._selectedMovie)||void 0===t?void 0:t.id)===e.id?void 0:e}_onDialogPosterClick(e){var t;this._dialogSelectedMovie=(null===(t=this._dialogSelectedMovie)||void 0===t?void 0:t.id)===e.id?void 0:e}async _onAddMovie(e,t,i,r){try{return await async function(e,t,i,r,o,s=!0){await e.callService("radarr_hacs","add_movie",{entry_id:t,tmdb_id:i.tmdbId,title:i.title,year:i.year,quality_profile_id:r,root_folder:o,monitored:s})}(this.hass,this._config.entry_id,e,t,i,r),this._selectedMovie=void 0,this._dialogSelectedMovie=void 0,this._searchTerm="",this._isTmdbView=!1,void await this._loadData()}catch(e){return String(e)}}async _onDeleteMovie(e){try{await async function(e,t,i,r=!1){await e.callService("radarr_hacs","delete_movie",{entry_id:t,movie_id:i,delete_files:r})}(this.hass,this._config.entry_id,e.id),this._selectedMovie=void 0,this._dialogSelectedMovie=void 0}catch(e){this._error=`Delete failed: ${e}`}finally{await this._loadData()}}async _onToggleMonitored(e){var t,i;const{movie:r,monitored:o}=e.detail;try{await async function(e,t,i,r){await e.callService("radarr_hacs","toggle_monitored",{entry_id:t,movie_id:i,monitored:r})}(this.hass,this._config.entry_id,r.id,o),await this._loadData(),(null===(t=this._selectedMovie)||void 0===t?void 0:t.id)===r.id&&(this._selectedMovie=this._filteredMovies.find(e=>e.id===r.id)),(null===(i=this._dialogSelectedMovie)||void 0===i?void 0:i.id)===r.id&&(this._dialogSelectedMovie=this._filteredMovies.find(e=>e.id===r.id))}catch(e){this._error=`Could not update monitored: ${e}`}}async _onSearchNow(e){const t=e.detail;try{await async function(e,t,i){await e.callService("radarr_hacs","trigger_search",{entry_id:t,movie_id:i})}(this.hass,this._config.entry_id,t.id)}catch(e){this._error=`Search failed: ${e}`}}async _onAddMovieEvent(e){const{movie:t,qualityProfileId:i,rootFolder:r,monitored:o}=e.detail,s=e.target,a=await this._onAddMovie(t,i,r,o);s.addComplete(a)}async _onDeleteMovieEvent(e){await this._onDeleteMovie(e.detail)}_onDialogSearchAgain(e){this._dialogSelectedMovie=void 0,this._tmdbForced=!1;const t=e.detail;this._searchTerm=t.title;const i=t.title.toLowerCase();this._filteredMovies=this._movies.filter(e=>e.title.toLowerCase().includes(i)),0===this._filteredMovies.length&&setTimeout(()=>this._tmdbSearch(),400)}_openDialog(){this._dialogOpen=!0}_onDialogClose(){this._dialogOpen=!1,this._dialogSelectedMovie=void 0}_renderGrid(e,t,i,r,o,s,a,n){var l,d;if(!e.length)return L`<div class="empty">${this._searchTerm?"No results":"No movies found"}</div>`;const c=null!==(d=null===(l=this._config)||void 0===l?void 0:l.columns)&&void 0!==d?d:4,h=null!=t?e.findIndex(e=>e.id===t.id):-1,p=h>=0?Math.min(Math.floor(h/c)*c+c-1,e.length-1):-1;return L`
      <div class="grid" style="grid-template-columns:repeat(${c},1fr)">
        ${e.map((e,l)=>{var d,c,h,u,v;return L`
          <radarr-movie-poster
            .movie=${e}
    ...
    `}render(){var e;if(!this._config)return L``;const t=null!==(e=this._config.card_title)&&void 0!==e?e:"Radarr",i=!1!==this._config.show_filter_counts;return L`
      ...
      ${this._loading||this._error?"":L`
        ${this._renderGrid(this._displayMovies,this._selectedMovie,e=>this._onPosterClick(e),this._onAddMovieEvent,this._onDeleteMovieEvent,this._onToggleMonitored,this._onSearchNow)}
        ${this._hasMore?L`
