 ...
 */
const e=globalThis,i=e.ShadowRoot&&(void 0===e.ShadyCSS||e.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,s=Symbol(),r=new WeakMap;let o=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==s)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(i&&void 0===t){const i=void 0!==e&&1===e.length;i&&(t=r.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&r.set(e,t))}return t}toString(){return this.cssText}};const n=(t,...e)=>{const i=1===t.length?t[0]:e.reduce((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new o(i,t,s)},a=i?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return(t=>new o("string"==typeof t?t:t+"",void 0,s))(e)})(t):t,{is:l,defineProperty:d,getOwnPropertyDescriptor:c,getOwnPropertyNames:h,getOwnPropertySymbols:p,getPrototypeOf:u}=Object,_=globalThis,f=_.trustedTypes,v=f?f.emptyScript:"",g=_.reactiveElementPolyfillSupport,m=(t,e)=>t,$={toAttribute(t,e){switch(e){case Boolean:t=t?v:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},y=(t,e)=>!l(t,e),b={attribute:!0,type:String,converter:$,reflect:!1,useDefault:!1,hasChanged:y};
/**
 * @license
 ...
 */function ut(t){return pt({...t,state:!0,attribute:!1})}async function _t(t,e,i={}){const s={type:"radarr_hacs/get_movies",entry_id:e};i.filter&&"all"!==i.filter&&(s.filter=i.filter),i.sort&&(s.sort=i.sort),i.search&&(s.search=i.search);return(await t.connection.sendMessagePromise(s)).movies}async function ft(t,e){return t.connection.sendMessagePromise({type:"radarr_hacs/get_config",entry_id:e})}let vt=class extends at{setConfig(t){this._config={...t},this.requestUpdate()}render(){var t,e,i,s;if(!this._config)return L``;const r=this._config;return L`
    ...
    `}_str(t){return e=>this._fire({[t]:e.target.value})}_fire(t){this._config={...this._config,...t},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0})),this.requestUpdate()}};vt.styles=n`
  ...
  `,t([pt({attribute:!1})],vt.prototype,"hass",void 0),vt=t([dt("radarr-hacs-card-editor")],vt);const gt=[{key:"all",label:"All"},{key:"available",label:"Available"},{key:"missing",label:"Missing"},{key:"downloading",label:"Downloading"}];let mt=class extends at{constructor(){super(...arguments),this.activeFilter="all"}render(){return L`${gt.map(t=>L`
      <button
  ...
  `,t([pt()],mt.prototype,"activeFilter",void 0),mt=t([dt("radarr-filter-chips")],mt);let $t=class extends at{constructor(){super(...arguments),this.selected=!1,this.showBadge=!0,this.radius=8}get _poster(){var t,e,i,s;return null!==(s=null===(i=null===(e=null===(t=this.movie)||void 0===t?void 0:t.images)||void 0===e?void 0:e.find(t=>"poster"===t.coverType))||void 0===i?void 0:i.remoteUrl)&&void 0!==s?s:""}render(){const t=function(t){return t.hasFile?"available":t.hasFile||t.isAvailable?"missing":"downloading"}(this.movie);return L`
      <div
  ...
  `,t([pt({attribute:!1})],$t.prototype,"movie",void 0),t([pt({type:Boolean})],$t.prototype,"selected",void 0),t([pt({type:Boolean})],$t.prototype,"showBadge",void 0),t([pt({type:Number})],$t.prototype,"radius",void 0),$t=t([dt("radarr-movie-poster")],$t);let yt=class extends at{constructor(){super(...arguments),this.movies=[],this.columns=4,this.showBadges=!0,this.posterRadius=8}render(){return this.movies.length?L`
    ...
    `:L`<div class="empty">No movies found</div>`}};yt.styles=n`
